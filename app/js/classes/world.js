class World {
  ...
  checkCollision(xx, yy) {
    ...
    for (var x = 0; x < this.currentBrick.width; x++) {
      for (var y = 0; y < this.currentBrick.height; y++) {
  ...
  render() {
    ...
    for (var x = 0; x < this.width; x++) {
      for (var y = 0; y < this.height; y++) {
        ...
        for (var bx = 0; bx < this.currentBrick.width; bx++) {
          for (var by = 0; by < this.currentBrick.height; by++) {
